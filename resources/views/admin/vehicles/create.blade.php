...
@section('content')
<div class="mb-4">
    <h2 class="page-title"><i class="fas fa-bus me-2"></i>Create Vehicle</h2>
</div>
                ...
                <form action="{{ route('admin.vehicles.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('license_plate') is-invalid @enderror" 
                               name="license_plate" value="{{ old('license_plate') }}" placeholder="e.g., กง-1234" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('vehicle_model') is-invalid @enderror" 
                               name="vehicle_model" value="{{ old('vehicle_model') }}" placeholder="e.g., Toyota Hiace">
